...
def _resolve_pypi_manifests(
    project, package_registry, pypi_resources, model, resolved_packages, sboms_headers
):
    """Resolve PyPI packages from requirement files."""
...
def _resolve_other_manifests(
    ...
    """Resolve non-PyPI packages from manifest files."""
