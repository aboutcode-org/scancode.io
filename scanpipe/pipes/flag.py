...
def read_file_head_text(location, max_bytes=8192):
    """
    Read up to `max_bytes` from `location` and return a lower-cased text string.
    ...
    # Decode as UTF-8, falling back to latin-1 which never fails.
    try:
