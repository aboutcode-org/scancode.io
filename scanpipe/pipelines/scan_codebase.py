...
class ScanCodebase(Pipeline):
    """
    A pipeline to scan a codebase resource with ScanCode-toolkit. If the codebase consists
    of several packages and dependencies, it will try to resolve and scan those too.
